    ...
    try {
        ...
        container.innerHTML = `
            ...
            <div class="email-detail-card">
                ...
                ${email.body ? `
                    <div class="email-body-preview" style="background: var(--bg-surface, #f8fafc); border: 1px solid var(--border-color, #e2e8f0); border-radius: 8px; padding: 1.25rem; margin-bottom: 1.5rem; font-size: 0.92rem; line-height: 1.6; white-space: pre-wrap; max-height: 300px; overflow-y: auto; color: var(--text-primary, #334155);">
